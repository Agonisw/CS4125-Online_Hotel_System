<template>
    <div class="header">
        ...
        <div class="logo">Hotel Website</div>
...
<!--                    <img :src="this.$store.state.user.imageUrl" />-->
                </div>
                <!-- 用户名下拉菜单 -->
...
import { getNoticeList, getUserList, saveAndUpdateEmployeeInfo, saveAndUpdateUserInfo } from '../../api/cake';
export default {
    data() {
        return {
            form:{
